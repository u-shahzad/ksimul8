class Priorites:
    ...
    def selectorSpreadPriority():
        '''
            ...
            belong to the same Service, StatefulSet or ReplicaSet.
        '''
    ...
    def requestedToCapacityRatioPriority():
        '''
            Creates a requestedToCapacity based ResourceAllocationPriority using
            default resource scoring function shape.
        '''
